...
-- AI Provider Settings (Gemini 3 Flash)
('gemini_api_key', 'AIzaSyBqQtp0aW4XbylNmece4EnQ5HCfxpXg_jA', 'STRING', 'AI_PROVIDER', 'GLOBAL', 'Gemini API key', ''),
('gemini_model', 'gemini-3-flash-preview', 'STRING', 'AI_PROVIDER', 'GLOBAL', 'Gemini model name', 'gemini-3-flash-preview'),
('ai_temperature', '0.3', 'NUMBER', 'AI_PROVIDER', 'GLOBAL', 'AI temperature (0.3 for financial determinism)', '0.3'),
('ai_max_tokens', '8192', 'NUMBER', 'AI_PROVIDER', 'GLOBAL', 'Maximum AI response tokens', '8192'),
('ai_thinking_level', 'LOW', 'STRING', 'AI_PROVIDER', 'GLOBAL', 'Gemini 3 thinking level (MINIMAL/LOW/MEDIUM/HIGH)', 'LOW'),
('ai_enabled', 'true', 'BOOLEAN', 'AI_PROVIDER', 'GLOBAL', 'Enable AI trend analysis', 'true'),
